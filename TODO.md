...
- Move each repo to a dev branch.
  ...
  - Update tests.yml? Maybe not actually...
  - Update builds.yml to trigger on merge?
    - It'll need to accept version and description parameters.
...
- DOCS:
  ...
  - List getting-started steps:
    - Initialize submodules (recursively).
  - Have high-level overview sections in the root README for:
    - How to access Releases.
    - GitHub Actions workflows.
    - The Surfacer algorithm.
    - SnoreCore module registration.
    - Why SnoreCore exists in the first place.
    - The purpose of the other repos.
    - A description of the old 3.x versions.
    - List the latest Release (with a link) at the top of the README.
    - Also link to the Godot Asset Library.
    - Also link to the demo for the given repo.
    - Also link to my portfolio, and to my devlog.
