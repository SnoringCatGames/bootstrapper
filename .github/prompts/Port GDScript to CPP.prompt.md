...
- Create a test file for the C++ code. Use the GoogleTest framework.
...
- Use GoogleTest assertions like EXPECT_EQ, EXPECT_TRUE, etc. for testing.
- Preserve comments from the original GDScript file.
- If the GDScript had function comments, place those comments above the function declaration in the ported header file.
